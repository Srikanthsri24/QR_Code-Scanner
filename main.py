...
title = tk.Label(window, text="Attendance System V-089", bd=10, relief=tk.GROOVE, font=("times new roman", 40),
...
ttk.Label(window, text="Year", background="lavender", foreground="black", font=("Times New Roman", 15)).place(x=100,
                                                                                                              y=150)
...
ttk.Label(window, text="Branch", background="lavender", foreground="black", font=("Times New Roman", 15)).place(x=100,
                                                                                                                y=200)
...
ttk.Label(window, text="Section", background="lavender", foreground="black", font=("Times New Roman", 15)).place(x=100,
                                                                                                                 y=250)
...
ttk.Label(window, text="Period", background="lavender", foreground="black", font=("Times New Roman", 15)).place(x=100,
                                                                                                                y=300)
...
exit_button = tk.Button(window, width=13, text="Submit", font=("Times New Roman", 15), command=checkk, bd=2,
                        relief=RIDGE)
...
def enterData(z):
    if z in names:
        ...
        fob.write(
            z + '\t' + branch.get() + '-' + sec.get() + '\t' + year.get() + '\t' + period.get() + '\t' + intime + '\n')
    return names
